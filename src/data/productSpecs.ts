...
export const productSpecs: ProductSpecs[] = [
  {
    slug: "lite",
    blurb:
      "A compact, high-yield ink tank printer for everyday and photo printing, now in an improved, more compact and lightweight design, with a replaceable maintenance box and printhead durability rated up to 50,000 pages.",
    brochure: "/brochures/epson-l1350.pdf",
    headline: [
      { label: "Print speed", value: "Up to 11.0 ipm black / 6.0 ipm colour" },
      ...
      { label: "Ink yield", value: "Up to 4,700 pages black / 7,500 pages colour (composite)" },
    ],
    detailed: [
      { label: "Dimensions & weight", value: "152 × 317 × 361 mm, 3.1 kg" },
      { label: "Power consumption", value: "Operating 12.0 W, Sleep 0.5 W" },
      ...
      { label: "Durability", value: "Rated up to 50,000 pages, printhead covered under warranty" },
      { label: "Mobile app", value: "Epson Smart Panel, Epson Connect, AirPrint, Mopria" },
